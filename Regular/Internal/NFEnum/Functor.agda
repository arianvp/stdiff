...
module Regular.Internal.NFEnum.Functor
...
-- ** Enumerating alignments
  ...
  align' : ∀{π₁ π₂} → Phase → ⟦ π₁ ⟧P Rec → ⟦ π₂ ⟧P Rec → M (Al TrivialA π₁ π₂)
  align' _ [] [] = return A0
  align' _ [] (at₂ ∷ ats₂) = Ains at₂ <$> align' I [] ats₂
  align' _ (at₁ ∷ ats₁) [] = Adel at₁ <$> align' D ats₁ []
  align' {α₁ ∷ π₁} {α₂ ∷ π₂} I (at₁ ∷ ats₁) (at₂ ∷ ats₂) with α₁ ≟Atom α₂
  ... | yes refl = AX (at₁ , at₂) <$> align' C ats₁ ats₂
                 ∣ Adel at₁ <$> align' D ats₁ (at₂ ∷ ats₂)
                 ∣ Ains at₂ <$> align' I (at₁ ∷ ats₁) ats₂ 
  ... | no ¬p = Adel at₁ <$> align' D ats₁ (at₂ ∷ ats₂)
              ∣ Ains at₂ <$> align' I (at₁ ∷ ats₁) ats₂
  align' {α₁ ∷ π₁} {α₂ ∷ π₂} D (at₁ ∷ ats₁) (at₂ ∷ ats₂) with α₁ ≟Atom α₂
  ... | yes refl = AX (at₁ , at₂) <$> align' C ats₁ ats₂
                 ∣ Adel at₁ <$> align' D ats₁ (at₂ ∷ ats₂)
  ... | no ¬p = Adel at₁ <$> align' D ats₁ (at₂ ∷ ats₂)
  align' {α₁ ∷ π₁} {α₂ ∷ π₂} C (at₁ ∷ ats₁) (at₂ ∷ ats₂) with α₁ ≟Atom α₂
  ... | yes refl = AX (at₁ , at₂) <$> align' C ats₁ ats₂
                 ∣ Ains at₂ <$> align' I (at₁ ∷ ats₁) ats₂
  ... | no ¬p = Ains at₂ <$> align' I (at₁ ∷ ats₁) ats₂
